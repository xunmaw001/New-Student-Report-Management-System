                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>辅导员</label>
                                        <select id="fudaoyuanTypesSelect" name="fudaoyuanTypes" class="form-control">
                                        </select>
                                    </div>
...
<script>
    ...
    <!-- 初始化当前表的下拉框 -->
        ...
        function initializationFudaoyuantypesSelect(){
            var fudaoyuanTypesSelect = document.getElementById('fudaoyuanTypesSelect');
            if(fudaoyuanTypesSelect != null && fudaoyuanTypesOptions != null  && fudaoyuanTypesOptions.length > 0 ){
                for (var i = 0; i < fudaoyuanTypesOptions.length; i++) {
                    fudaoyuanTypesSelect.add(new Option(fudaoyuanTypesOptions[i].indexName,fudaoyuanTypesOptions[i].codeIndex));
                }
            }
        }
    ...
    function setSelectOption() {
        ...
        if(fudaoyuanTypesSelect != null && fudaoyuanTypesOptions != null  && fudaoyuanTypesOptions.length > 0 ) {
            for (var i = 0; i < fudaoyuanTypesOptions.length; i++) {
                if (fudaoyuanTypesOptions[i].codeIndex == ruleForm.fudaoyuanTypes) {//下拉框value对比,如果一致就赋值汉字
                        fudaoyuanTypesSelect.options[i].selected = true;
                }
            }
        }
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            ...
            messages: {
                ...
                zhuanyeTypes: "专业不能为空",
                banjiTypes: "班级不能为空",
                fudaoyuanTypes: "辅导员不能为空",
                // yonghuYesnoTypes: "是否报道不能为空",
            }
        }).form();
    }
    ...
    $(document).ready(function () {
        ...
        // 初始化下拉框
            ...
            initializationFudaoyuantypesSelect();
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            var addyonghu = window.sessionStorage.getItem("addyonghu");
            if(addyonghu != null && addyonghu != ""){
                $(".bbbbbb").remove();
            }
        }else if (window.sessionStorage.getItem('role') == '用户') {
            $(".aaaaaa").remove();
            $('#yonghuYesnoTypesSelect').attr('readonly', 'readonly');
            $('#yonghuYesnoTypesSelect').attr('style', 'pointer-events: none;');
            $('#xueyuanTypesSelect').attr('readonly', 'readonly');
            $('#xueyuanTypesSelect').attr('style', 'pointer-events: none;');
            $('#zhuanyeTypesSelect').attr('readonly', 'readonly');
            $('#zhuanyeTypesSelect').attr('style', 'pointer-events: none;');
            $('#banjiTypesSelect').attr('readonly', 'readonly');
            $('#banjiTypesSelect').attr('style', 'pointer-events: none;');
            $('#fudaoyuanTypesSelect').attr('readonly', 'readonly');
            $('#fudaoyuanTypesSelect').attr('style', 'pointer-events: none;');
            $('#yonghuNumber').attr('readonly', 'readonly');
        }else{
            // alert("未知情况.......");
        }
    }
