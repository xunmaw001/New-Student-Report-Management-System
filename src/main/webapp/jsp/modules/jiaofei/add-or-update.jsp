                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表的字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>辅导员</label>
                                        <input id="fudaoyuanValue" name="fudaoyuanValue" class="form-control"
                                               placeholder="辅导员" readonly>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>是否报道</label>
                                        <input id="yonghuYesnoValue" name="yonghuYesnoValue" class="form-control"
                                               placeholder="是否报道" readonly>
                                    </div>
                            <!-- 当前表的字段 -->
                                ...
                                <input id="yonghuId" name="yonghuId" type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>应缴金额</label>
                                        <input id="jiaofeiYingjiaoMoney" name="jiaofeiYingjiaoMoney" class="form-control"
                                               onchange="jiaofeiYingjiaoMoneyChickValue(this)" placeholder="应缴金额">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>实收金额</label>
                                        <input id="jiaofeiShishouMoney" name="jiaofeiShishouMoney" class="form-control"
                                               onchange="jiaofeiShishouMoneyChickValue(this)" placeholder="实收金额">
                                    </div>
                                    <div class="form-group  col-md-6">
                                        <label>备注</label>
...
<script>
    ...
    //数字检查
        <!-- 当前表的数字检查 -->
        function jiaofeiYingjiaoMoneyChickValue(e){
        ...
        function jiaofeiShishouMoneyChickValue(e){
            var this_val = e.value || 0;
            var reg=/^[0-9]{0,6}(\.[0-9]{1,2})?$/;
            if(!reg.test(this_val)){
                e.value = "";
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                ...
                insertTime: "required",
                jiaofeiYingjiaoMoney: "required",
                // jiaofeiShishouMoney: "required",
                jiaofeiContent: "required",
            },
            messages: {
                yonghuId: "学生不能为空",
                jiaofeiName: "缴费名目不能为空",
                jiaofeiTypes: "缴费类型不能为空",
                insertTime: "发布时间不能为空",
                jiaofeiYingjiaoMoney: "应缴金额不能为空",
                // jiaofeiShishouMoney: "实收金额不能为空",
                jiaofeiContent: "备注不能为空",
            }
        }).form();
    }
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#jiaofeiYingjiaoMoney").val(ruleForm.jiaofeiYingjiaoMoney);
        $("#jiaofeiShishouMoney").val(ruleForm.jiaofeiShishouMoney);
    ...
    function yonghuDataBind(){
        ...
        $("#fudaoyuanValue").val(ruleForm.fudaoyuanValue);
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            ...
            $(".aaaaaa").remove();
            // 应缴金额设置不可选
            $('#jiaofeiYingjiaoMoney').attr('readonly', 'readonly');
            // 实收金额设置不可选
            $('#jiaofeiShishouMoney').attr('readonly', 'readonly');
        }else{
            // alert("未知情况.......");
        }
    }
