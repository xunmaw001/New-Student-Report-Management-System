            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">辅导员管理</li>
                        <li class="breadcrumb-item active">编辑辅导员</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">辅导员表信息</h3>
...
<script>
    ...
    var tableName = "dictionaryFudaoyuan";
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            data["dicCode"] = "fudaoyuan_types";
            data["dicName"] = "辅导员名字名称";
