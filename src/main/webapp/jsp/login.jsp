        ...
        <form id="loginForm" action="" method="post" class="form">
            ...
            <div class="body-content">
				...
				<div class="form-group">
                    <div class="checkbox-list">
                        <label>
                            <input type="radio" name="chk" value="负责人" onclick="checkRole('fuzeren')">&nbsp;负责人
                        </label>
                    </div>
                </div>
				...
				<%--<div class="form-group"><button type="button" class="btn btn-success" style="width: 100%;" onclick="window.location.href='./modules/fuzeren/register.jsp'">注册  负责人</button></div>--%>
